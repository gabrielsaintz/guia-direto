...
export const metadata: Metadata = {
  title: "Guia Direto — Seus direitos trabalhistas em linguagem clara",
  description:
    "Descubra seus direitos trabalhistas de forma simples e direta. Para trabalhadores de Conde-PB e região.",
};
